...
const About = () => {
    ...
    // const [style,setmyStyle]=useState("Enable Darkmode");  or object v pass kar sakte h apna useState ka parameters
    ...
    return (
        <>
            ...
            <button type="button" className="btn btn-primary" onClick={darkModeHandle}>{btnText}</button>
